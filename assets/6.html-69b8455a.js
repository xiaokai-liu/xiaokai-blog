import{_ as t,r as p,o as e,c as o,a as n,b as s,e as c,f as l}from"./app-97481773.js";const i="/assets/init-57961954.png",u="/assets/initvue2-48d9c206.png",r={},k=n("h1",{id:"vue2源码解析-响应式原理",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue2源码解析-响应式原理","aria-hidden":"true"},"#"),s(" vue2源码解析-响应式原理")],-1),d=n("h2",{id:"vue源码获取",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#vue源码获取","aria-hidden":"true"},"#"),s(" vue源码获取")],-1),v={href:"https://github.com/vuejs/vue",target:"_blank",rel:"noopener noreferrer"},m=l('<h2 id="首次渲染过程" tabindex="-1"><a class="header-anchor" href="#首次渲染过程" aria-hidden="true">#</a> 首次渲染过程</h2><p>Vue的初始化已经完毕后，才开始进行首次渲染</p><figure><img src="'+i+`" alt="init" tabindex="0" loading="lazy"><figcaption>init</figcaption></figure><h2 id="响应式处理的入口" tabindex="-1"><a class="header-anchor" href="#响应式处理的入口" aria-hidden="true">#</a> 响应式处理的入口</h2><ul><li>src/core/instance/init.js <ul><li>initState(vm) vm 状态的初始化</li><li>初始化了 _data、_props、methods 等</li></ul></li><li>src/core/instance/state.js</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">if</span> <span class="token punctuation">(</span>opts<span class="token punctuation">.</span>data<span class="token punctuation">)</span> <span class="token punctuation">{</span>

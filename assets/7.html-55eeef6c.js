import{_ as p,r as o,o as c,c as i,a as s,b as n,e as t,f as e}from"./app-ecd677b5.js";const l={},u=e(`<h1 id="vuerouter简单实现" tabindex="-1"><a class="header-anchor" href="#vuerouter简单实现" aria-hidden="true">#</a> vueRouter简单实现</h1><p>我们先来了解vue-router的简单使用，先了解怎么使用，之后再去想办法怎么去实现</p><h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2><p>路由：本质上是一种对应关系</p><ul><li>前端路由</li></ul><p>在SPA（单页应用）中根据用户所触发的事件改变了URL 在无需刷新的前提下 显示不同的页面内容，比如等下就要讲的Vue Router</p><ul><li>后端路由</li></ul><p>比如node.js 的路由是 URL的请求地址和服务器上面的资源对应，根据不同的请求地址返回不同的资源</p><h2 id="vue-router最基础的使用步骤" tabindex="-1"><a class="header-anchor" href="#vue-router最基础的使用步骤" aria-hidden="true">#</a> vue-router最基础的使用步骤</h2><ol><li>引入vue-router文件</li></ol><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!-- 使用vue router前提 vue 必不可少 --&gt;</span>
